...
import edu.kit.pse.a1sicht.databinding.ActivityAdminReviewScreenBinding
import kotlinx.android.synthetic.main.activity_admin_review_screen.*
...
class ReviewScreenActivity: BaseActivity(){
    ...
    private lateinit var binding :ActivityAdminReviewScreenBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(R.layout.activity_admin_review_screen)

        reviewScreenViewModel = ViewModelProviders.of(this).get(ReviewScreenViewModel::class.java)
        binding = DataBindingUtil.setContentView(this,R.layout.activity_admin_review_screen)
