...
class HomeStudentActivity: BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        homeStudentViewModel = ViewModelProviders.of(this).get(HomeStudentViewModel::class.java)
    ...
    private fun getStudentReviews() {
        ...
        homeStudentViewModel.getStudentReviews(1).observe(this, Observer<List<Review>> { list ->
            list.forEach {
                reviews.add(it)
            }
    ...
    private fun createAdapterForReviews(reviews: ArrayList<Review>) {
        ...
        val mListener = object: ReviewAdapter.OnItemClickListener{
            override fun onDeleteClick(position: Int) {
                ...
                homeStudentViewModel.signOut(review)
