 ...
 * data for [ReviewCreationActivity] and [ReviewScreenActivity].
 *
...
class ReviewScreenViewModel(application: Application):AndroidViewModel(application) {
    ...
    private val _reviewDate:MutableLiveData<String> = MutableLiveData()
    private val _reviewTime:MutableLiveData<String> = MutableLiveData()
    ...
    fun getSignedStudents():LiveData<String>{
        ...
        _signedStudents.value = signedStudents.toString()
     ...
     * @return [String] Returns a live data object containing string
     */
    fun getReviewDate():LiveData<String>{
        _reviewDate.value = "${_review.value!!.date!!.day}/${_review.value!!.date!!.month}/${_review.value!!.date!!.year+1900}"
        return _reviewDate
    }

    /**
     * This method returns the start time of a review.
     *
     * @return [String] Returns a live data object containing string
     */
    @TargetApi(Build.VERSION_CODES.O)
    fun getReviewTime():LiveData<String>{
        val formatter = DateFormat.getTimeInstance()
        _reviewTime.value = formatter.format(_review.value!!.date)
        return _reviewTime
    }
