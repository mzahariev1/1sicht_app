...
data class Review(
    @PrimaryKey @ColumnInfo(name = "review_id") val id: Int?,
    ...
    @ColumnInfo(name = "timeSlotLength") var timeSlotLength: Int,
    @ColumnInfo(name = "numberOfTimeSlots") var numberOfTimeSlots: Int,
