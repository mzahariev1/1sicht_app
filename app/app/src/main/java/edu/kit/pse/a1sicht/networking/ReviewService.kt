...
interface ReviewService {
    ...
    fun signUpForTimeslot(@Path("timeslotId") timeslotId: Int, @Path("studentId") studentId: Int): Observable<Boolean>
    ...
    fun signOutFromTimeslot(@Path("timeslotId") timeslotId: Int, @Path("studentId") studentId: Int): Observable<Boolean>
